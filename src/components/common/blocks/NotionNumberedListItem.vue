...
const hasChildren = props.block.has_children && props.block.numbered_list_item.children;
...
<template>
  <li>
    ...
    <div v-if="hasChildren" class="nested-list">
      ...
      <NotionBlockRenderer :blocks="block.numbered_list_item.children" :level="level + 1" />
    </div>
  </li>
</template>
