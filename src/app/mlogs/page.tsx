      ...
      <section className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="lg:col-span-5 relative group flex justify-center">
           ...
           <div className="lg:col-span-7 flex flex-col justify-center space-y-8">
                ...
                {/* Controls */}
                <div className="bg-card border border-card-border rounded-2xl p-6 backdrop-blur-sm">
                    ...
                    <div className="flex justify-between items-center">
                         ...
                         <div className="flex items-center gap-6">
                             <button className="text-muted hover:text-foreground transition-colors"><SkipBack size={24} /></button>
                             <button 
                                 onClick={() => setIsPlaying(!isPlaying)}
                                 className="w-12 h-12 bg-foreground text-background rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                             >
                                 {isPlaying ? <Pause size={24} fill="currentColor" /> : <PlayCircle size={24} fill="currentColor" />}
                             </button>
                             <button className="text-muted hover:text-foreground transition-colors"><SkipForward size={24} /></button>
                         </div>
       ...
       <section className="space-y-6">
          <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                  <button className="px-3 py-1.5 rounded-lg text-xs font-mono bg-card text-foreground border border-card-border">REVIEWS</button>
                 ...
                 <SpotlightCard key={log.id} className="p-4 flex gap-4 group cursor-pointer rounded-2xl">
                     ...
                     <div className="flex flex-col justify-between py-1 flex-grow">
                         <div>
                             ...
                             <h3 className={cn("text-lg font-medium text-foreground leading-tight mb-1 transition-colors group-hover:text-rose-500")}>
                                 {log.title}
                             </h3>
